...
#pragma unroll
            ...
            rocprim_warpSum<GSPLAT_HIP_WARP_SIZE>(v_mean_local, warp_storage_base);        // vec3
            rocprim_warpSum<GSPLAT_HIP_WARP_SIZE>(v_scale_local, warp_storage_base);       // vec3
            rocprim_warpSum<GSPLAT_HIP_WARP_SIZE>(v_quat_local, warp_storage_base);        // vec4
